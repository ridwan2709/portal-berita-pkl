			...
			<div class="block">
								...
								<ul>
									<?php
										  ...
										  foreach ($hasil->result_array() as $row) {	
											  ...
											  echo "<li><a href='".base_url()."berita/detail/$row[judul_seo]''>$row[judul]</a><a href='#' class='h-comment'>$total_komentar_terkait</a></li>";
										  }      
									?>
								</ul>
				...
				<div class="block-content">
					<div class="comment-block">
						<div class="fb-comments" data-href="<?php echo base_url().'/berita/detail/'.$rows['judul_seo']; ?>" data-width="830" data-numposts="5" data-colorscheme="light"></div> 
					</div>
				</div>
